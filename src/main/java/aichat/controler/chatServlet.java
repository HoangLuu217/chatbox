...
public class chatServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String name ;
        // Fake response từ bot (có thể gọi AI model ở đây)
        String botReply = "Xin chào Anh/Chị! Em là trợ lý ảo của Thế Giới Công Nghệ.";
        ProductVariant product = null;

       

        // Đẩy data về cho JSP hiển thị
